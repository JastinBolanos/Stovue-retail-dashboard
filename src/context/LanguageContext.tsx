...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'welcome.desc': 'Omnichannel retail operations platform with real-time SKU telemetry, algorithmic stock replenishment, and checkout dropout recovery.',
    ...
    'nodes.monitorTitle': 'LIVE NODE NETWORK & SUPPLY CHAIN TELEMETRY',
    'nodes.monitorCluster': 'CLUSTER: 100% NOMINAL',
    'nodes.online': 'ONLINE',
    'nodes.nominal': 'NOMINAL',
    'nodes.capacity': 'CAPACITY',
    'nodes.posLive': 'POS SYNC',
    'btn.demoCeo': 'DEMO PROFILE (CEO)',
  ...
  es: {
    ...
    'welcome.desc': 'Plataforma unificada de retail omnicanal con telemetría en tiempo real de SKUs, reabastecimiento algorítmico y recuperación de carritos.',
    ...
    'nodes.monitorTitle': 'ESTADO DE RED DE NODOS & TELEMETRÍA LOGÍSTICA',
    'nodes.monitorCluster': 'CLÚSTER: 100% NOMINAL',
    'nodes.online': 'EN LÍNEA',
    'nodes.nominal': 'NOMINAL',
    'nodes.capacity': 'CAPACIDAD',
    'nodes.posLive': 'SYNC POS',
    'btn.demoCeo': 'PERFIL DEMO (CEO)',
